...
const DiscoverPeople = () => {
    ...
    const fetchPeople = async () => {
        try {
            const res = await axios.get('http://51.20.6.6/api/connection/people/suggestions', { withCredentials: true })
    ...
    //     try {
    //         const res = await axios.post('http://51.20.6.6/api/connection/like/692bcd0bbaef054286ef3d64')
    //     } catch (error) {
