...
const Requests = () => {
  ...
  const fetchRequets = async () => {
    const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/connection/getRequests`, {
  ...
  const handleRequest = async (resStatus) => {
    ...
    try {
      const res = await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/connection/connections/${resStatus}/${requestedUser.fromId._id}`,
        {},
        { withCredentials: true }
      )
      console.log(res)
