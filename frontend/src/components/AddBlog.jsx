...
const AddBlog = () => {
    ...
    useEffect(() => {
        const fetchTags = async () => {
            ...
            const res = await axios.get('http://http://51.20.6.60/api/tags')
    ...
    const sendData = async () => {
        try {
            const res = await axios.post('http://http://51.20.6.60/api/blog', { title, content, tags }, { withCredentials: true })
            console.log(res)
        } catch (error) {
            console.log(error)
        }
